...
export default function CTA() {
  return (
    <>
      {/* Hero */}
      <div className="">
        <div className="max-w-[45rem] mx-auto px-4 sm:px-6 lg:px-8 py-20 -mt-10">
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            {/* Title */}
            <div className="text-center">
              <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl  not-prose mb-5 text-primary">
                <Balancer>
                  <WordPullUp
                    className="text-4xl font-bold tracking-[-0.02em] md:text-5xl md:leading-[4rem] "
                    words=" Recibie los mejores consejos para el cuidado de tus amigos peludos"
                  />
                </Balancer>
              </h1>

              <h4 className="text-1xl font-light text-center opacity-70 not-prose">
                <Balancer>
            ...
            <div className="sm:flex sm:justify-center sm:items-center text-center sm:text-start">
              <div className="flex-shrink-0  sm:flex sm:pb-0 sm:pe-5">
                {/* Avatar Group */}
