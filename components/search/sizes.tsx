  ...
  return (
    <Card className="p-8  rounded-lg w-full">
      <div className="flex flex-col lg:flex-row lg:items-center mb-2">
        <h2 className="text-2xl font-extrabold  lg:mr-2 mb-4 lg:mb-0 lg:w-1/3 text-primary">
          Tamaños promedio y expectativa de vida de la raza.
        </h2>
        <div className="flex flex-col lg:flex-row lg:w-full gap-4 ">
          <Card className="flex items-center space-x-4 p-4 rounded-lg shadow-sm border border-gray-200 lg:w-full transition-transform duration-300 ease-in-out transform hover:bg-gray-100 dark:hover:bg-secondary hover:border-primary hover:scale-105 ">
            <svg className="icon icon-breed-height w-16 " viewBox="0 0 79 54">
          ...
          <Card className="flex items-center space-x-4 p-4 rounded-lg shadow-sm border border-gray-200 lg:w-full transition-transform duration-300 ease-in-out transform hover:bg-gray-100 dark:hover:bg-secondary hover:border-primary hover:scale-105">
            <svg
              className="icon icon-breed-weight w-14 mt-3"
              viewBox="0 0 56 55"
            >
              <g fill="none" fill-rule="evenodd">
                <path
                ...
                <path
                  fill="#bfdeab"
                  d="M27.953 15.4L25.79 25.667h4.422z"
                ></path>
              </g>
              <g fill="none" fill-rule="evenodd">
                <path
          ...
          <Card className="flex items-center space-x-4 p-4 rounded-lg shadow-sm border border-gray-200 lg:w-full transition-transform duration-300 ease-in-out transform hover:bg-gray-100 dark:hover:bg-secondary hover:border-primary hover:scale-105">
            <svg
              className="icon icon-breed-life-expectancy w-14 mt-2"
              viewBox="0 0 56 58"
            >
              <g fill="none" fill-rule="evenodd">
                <path
