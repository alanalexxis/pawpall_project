export const alimentacion = `
    ...
    <ul>
      <li>
        <p><strong>Cachorros:</strong> Los cachorros necesitan más comidas al día debido a su rápido crecimiento. Se recomienda alimentar a los cachorros entre 3 y 4 veces al día hasta que tengan alrededor de 6 meses de edad.</p>
      </li>
      <li>
        <p><strong>Perros adultos:</strong> Una vez que tu perro alcanza la edad adulta (generalmente alrededor de 1 año), puedes reducir la frecuencia a 2 comidas al día. Algunos perros pueden adaptarse bien a una comida al día, pero esto depende de su nivel de actividad y preferencias.</p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <p><strong>Perros pequeños:</strong> Los perros de razas pequeñas tienen metabolismos más rápidos y pueden necesitar comer más frecuentemente para mantener sus niveles de energía. Alimentarlos 3 veces al día puede ser ideal.</p>
      </li>
      <li>
    ...
    <blockquote>
      <p>
        Si tu perro deja de comer de repente o muestra otros síntomas preocupantes, consulta a un veterinario para asegurarte de que no haya un problema subyacente.
      </p>
    </blockquote>
    <h2>Conclusión</h2>
    <p>
      Alimentar a tu perro la cantidad y frecuencia correctas es clave para su salud y bienestar. Ten en cuenta la edad, tamaño, raza, y nivel de actividad de tu perro al determinar su rutina de alimentación. Si tienes dudas, siempre es una buena idea consultar con un veterinario para obtener una recomendación personalizada.
    </p>
  `;
